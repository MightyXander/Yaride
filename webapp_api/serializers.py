...
def trip_card_to_dict(row: sqlite3.Row) -> dict[str, Any]:
    ...
    return {
        ...
        "driverRatingCount": int(_get(row, "driver_rating_count", 0) or 0),
        "driverTripsCount": int(_get(row, "driver_trips_count", 0) or 0),
        "driverCreatedAt": _get(row, "driver_created_at"),
