...
import { CarFront, UserRound, type LucideIcon } from "lucide-react";
    ...
    <div className="floating-nav-root pointer-events-none fixed inset-x-0 bottom-0 z-40 flex justify-center overflow-hidden pb-[max(14px,env(safe-area-inset-bottom,0px))] pt-3">
      <div className="w-[20rem] max-w-[calc(100%-2rem)]">
        <nav
          ...
          data-no-tap-glow
          className="pointer-events-auto relative grid h-[3.75rem] w-full grid-cols-2 gap-1 overflow-visible rounded-full border border-border/60 bg-card/95 p-1.5 shadow-floating-nav backdrop-blur-xl"
        >
          <div
            aria-hidden
